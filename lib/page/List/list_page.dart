...
class list_page extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        Get.delete<ArtikelController>();
        return true; // Izinkan pergi ke halaman sebelumnya
      },
      child: Scaffold(
        body: SafeArea(
            child: Center(
                      ...
                      return FutureBuilder(
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return Center(
                              child: Text(
                                  "Data Tidak Ditemukan atau Koneksi bermasalah"),
                            );
                          }
                        },
                      );
                          ...
                          if (index == artikelController.artikelList.length) {
                            ...
                            return listArt(
                                ...
                                _parseHtmlString(artikel.content.rendered)
                                    .replaceAll(RegExp('\n\n\n\n'), '\n\n'),
                                artikel.jetpackShortlink,
                                artikel.excerpt.rendered);
                          }
                        },
                      );
                    }
...
class listArt extends StatelessWidget {
  listArt(this.categr, this.judul, this.img, this.tgl, this.isi, this.url,
      this.deskripsi);
  String url;
  String deskripsi;
  String categr;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(
          artikel_page(judul, categr, img, tgl, isi, url, deskripsi),
